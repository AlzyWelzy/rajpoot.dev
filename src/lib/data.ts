import type { ProjectType, TestimonialType, IconName } from "./types";
...
// Grouped (rather than one flat list) so the Skills section can give each
// category its own accent color instead of one undifferentiated wall of
// identical pills.
...
// src/actions/index.ts. Without it, the widget doesn't render and every
...
// as the rest of this form's config.
